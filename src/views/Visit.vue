<template>
  <div>
    ...
    <h1 class="my-5">Explore things to do at Sharlock Zoo!</h1>

      <div>
      <div class="relative items-center justify-center">
        <!-- Header Text-->
        <h1
          class="text-center text-2xl font-bold p-4 bg-gray-800 text-gray-400"
        >
    ...
    <div
      class="w-4/5 m-auto h-auto py-4 bg-green-600 mt-10 flex flex-col book-tickets-div"
    >
      <h1 class="text-white m-auto">
        Book your Tickets to come and see us soon!
      </h1>
      <span
        class="material-icons material-icons-visit-arrow md:text-5xl p-2 md:p-3 lg:p-3 rounded-full"
      >
        arrow_downward
      </span>
      <router-link to="/book-tickets"
        class="w-40 bg-red-600 h-auto m-auto py-2 mt-2 rounded-xl text-xl font-bold text-white"
      >
       Book
      </router-link>
    </div>
...
<script>
import VisitBanner from "@/components/VisitPageComponents/VisitBaner.vue";
export default {
  data() {
    return {};
  },

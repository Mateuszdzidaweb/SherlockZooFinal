<template>
  <div>
    <div class="h-20 bg-green-700 lg:pt-40"></div>
    <h1 class="text-4xl pt-5">Discover Our Events</h1>
    <hr class="border-2 mt-2 w-5/6 m-auto border-green-700" />

    <div class="p-5 bg">
      <h1>Sherlock Zoo Bristol Events</h1>
    </div>
